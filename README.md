...
```sh
git clone https://github.com/EBB2675/nomad-parser-molpro.git
cd nomad-parser-molpro
...
```sh
pip install dist/nomad-parser-molpro-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| Esma Boydas | [esma.boydas@hu-berlin.de](mailto:esma.boydas@hu-berlin.de)
